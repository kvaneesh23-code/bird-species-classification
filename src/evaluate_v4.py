...
REPORT_PATH = "results/classification_report_v4.txt"
CM_PATH = "results/plots/confusion_matrix_v4.png"
...
with open(REPORT_PATH, "w") as f:
    f.write("MobileNetV2 V4 Fine-Tuned Classification Report\n")
    f.write("===============================================\n\n")
...
plt.title("MobileNetV2 V4 Fine-Tuned Confusion Matrix")
